...
class CreatePaymentRequest extends StatefulWidget {
  String frPayId = "";
  CreatePaymentRequest({Key? key, this.frPayId = ""}) : super(key: key);

  @override
  CreatePaymentRequestState createState() => CreatePaymentRequestState();
}

class CreatePaymentRequestState extends State<CreatePaymentRequest> {
      ...
      body: SingleChildScrollView(
        child: Column(
            children: [
              ...
              Center(child: Text("Faire une demande de paiement"),),
              Container(
