...
class TransactionMsgDetails extends StatefulWidget {
 // const TransactionMsgDetails({Key? key}) : super(key: key);
...
class TransactionDetailsState extends State<TransactionMsgDetails> {
